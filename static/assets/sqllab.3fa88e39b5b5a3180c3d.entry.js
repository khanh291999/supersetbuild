...
class FilterableTable extends react.PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      sortDirection: Table_SortDirection.ASC,
      fitted: false };
  ...
  formatTableData(data) {
    return data.map((row) => {
      ...
      Object.entries(row).forEach(([key, val]) => {
        ...
        {
          newRow[key] = val === null ? null : json_bigint_default().stringify(val);
        }
      });
      return newRow;
    });
  ...
  addJsonModal(node, jsonObject, jsonString) {
    return (0,emotion_react_browser_esm.jsx)(ModalTrigger/* default */.Z, { modalBody: (0,emotion_react_browser_esm.jsx)(lib/* default */.Z, { data: jsonObject, theme: JSON_TREE_THEME }), modalFooter: (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, null,
      (0,emotion_react_browser_esm.jsx)(CopyToClipboard/* default */.Z, { shouldShowText: false, text: jsonString })),
      modalTitle: (0,TranslatorSingleton.t)('Cell content'), triggerNode: node });
  }
...
/******/ 			// return url for filenames based on template
/******/ 			return "" + "sqllab" + "." + "3fa88e39b5b5a3180c3d" + ".entry.css";
/******/ 		};
/******/ 	})();
/******/ 	
